...
**Right now, signups don't go anywhere useful.** The form works, but with no
endpoint set it falls back to opening the visitor's mail app — and most people
don't finish that. Every name you're collecting today, you're mostly losing.
...
1. Go to **sheets.google.com** → blank spreadsheet. Name it `Inner Circle`.
