...
5. Change every `?v=29` reference in the HTML files to the next number after editing CSS or JavaScript.
...
Phones and data-saving connections intentionally use one looping opening clip, pause it off screen, and replace expensive moving texture effects with static treatments. Desktop keeps the full four-clip reel.
...
| `assets/css/system.css` | Dark desktop-window presentation and responsive system chrome |
