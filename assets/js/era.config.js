  ...
  hero: {
    ...
    /* Until that exists, these cross-fade with a slow drift.
       EACH ENTRY CAN BE A CLIP, NOT JUST A PHOTO:
         "assets/img/clips/wrist.mp4"   ← best. silent, looping, ~2MB
    ...
    /* ---- THE DOOR DOUBLES AS THE LOADING SCREEN --------------------
       ...
       ---------------------------------------------------------------- */
    loading: { label: "LOADING", maxWait: 4000, autoEnter: false },
    ...
    slides: [
      ...
      { src: "assets/img/clips/wrist.mp4",     fallback: "https://i.ytimg.com/vi/tE0BXfeUcWo/maxresdefault.jpg" },
      /* SPONSORED — high-contrast black and white */
      { src: "assets/img/clips/sponsored.mp4", fallback: "https://i.ytimg.com/vi/zkoz1tAjeEA/maxresdefault.jpg" },
      ...
      { src: "assets/img/clips/findyou.mp4",   fallback: "https://i.ytimg.com/vi/Se1q1ejP65g/sddefault.jpg" },
      /* TOO MANY — you in the backseat, Times Square out the window */
      { src: "assets/img/clips/toomany.mp4",   fallback: "https://i.ytimg.com/vi/e7SS51HBa5c/maxresdefault.jpg" }
    ],
